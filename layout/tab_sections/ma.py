...
ma_params_selector = (
    html.Section(
        children=[
            ...
            html.Div(
                children=[
                    html.Label('Select window size used to calculate: '),
                    dcc.Dropdown(
                        id='ma-window',
